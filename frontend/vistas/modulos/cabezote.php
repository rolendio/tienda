	...
	<div class="container">
		<div class="row" id="cabezote">
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
				...
				<a href="#">
					<img src="http://localhost/backend/<?php echo $social["logo"]; ?>" alt="logotipo" class="img-responsive">
				</a>
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="carrito">
				...
				<p>TU CESTA  3 <span class="cantidadCesta"></span><br>USD $ 20<span class="sumaCesta"></span></p>
